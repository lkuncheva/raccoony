...
import { Task, MoodOption, MOOD_CONFIG } from "@/types/app";
...
export default function TaskCard({ task, onEncouragementMessage }: Props) {
  ...
  const requiredHours = task.requiredWeeklyHours;
